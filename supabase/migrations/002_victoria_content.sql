...
drop policy if exists "Victoria admin manages categories" on public.categories;
drop policy if exists "Public can read available products" on public.products;
drop policy if exists "Admins manage products" on public.products;
drop policy if exists "Victoria admin manages products" on public.products;
drop policy if exists "Public can read product images" on public.product_images;
drop policy if exists "Admins manage product images" on public.product_images;
drop policy if exists "Victoria admin manages product images" on public.product_images;
...
drop policy if exists "Victoria admin manages product options" on public.product_options;
drop policy if exists "Public can read site settings" on public.site_settings;
drop policy if exists "Victoria admin manages site settings" on public.site_settings;
drop policy if exists "Public can read active homepage sections" on public.homepage_sections;
drop policy if exists "Victoria admin manages homepage sections" on public.homepage_sections;
drop policy if exists "Public can read active gallery" on public.gallery_items;
drop policy if exists "Victoria admin manages gallery" on public.gallery_items;
drop policy if exists "Public can read active promotions" on public.promotions;
drop policy if exists "Victoria admin manages promotions" on public.promotions;
...
drop policy if exists "Public can view Victoria media" on storage.objects;
drop policy if exists "Victoria admin can upload media" on storage.objects;
drop policy if exists "Victoria admin can update media" on storage.objects;
drop policy if exists "Victoria admin can delete media" on storage.objects;
